...
type Timer struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Json          *Json                  `protobuf:"bytes,1,opt,name=json,proto3" json:"json,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_timer_proto_rawDesc = "" +
	...
	"\x05Timer\x12\"\n" +
	"\x04json\x18\x01 \x01(\v2\x0e.BSB_Util.JsonR\x04jsonB?Z=github.com/brotherlogic/busybar-bridge/pkg/pb/busybar;busybarb\x06proto3"
